...
class ScienceTeachersView extends Component{
    state = {
        TeacherNotices:[],
        TeacherMaterials:[],
        open:false
    ...
    componentDidMount = async () => {
        ...
        then(res => {
            ...
            console.log("Damnn" + res.data.data);
    ...
    render() {
        return(
            <>
                <div style={{marginLeft:"4%",marginTop:"79px"}}>
...
export default ScienceTeachersView;